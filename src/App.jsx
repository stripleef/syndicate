  ...
  return (
    <header ref={heroRef} className="relative w-full h-[100svh] overflow-hidden flex flex-col bg-[#050505]">
       <video 
         ...
         muted 
         playsInline
         className="absolute inset-0 w-full h-full object-cover object-bottom md:object-center z-0 opacity-100 scale-[1.05] md:scale-100"
       />
       ...
       <div className="relative z-10 flex flex-col md:flex-row justify-between items-center px-4 md:px-12 pt-2 pb-0 md:pb-6 gap-1 md:gap-0 bg-black/40 backdrop-blur-2xl text-[11px] md:text-sm font-oswald tracking-[0.2em] text-parchment/90 font-bold uppercase mt-auto border-t border-white/10 shadow-[0_-10px_30px_rgba(0,0,0,0.5)] translate-y-1 md:translate-y-0">
    ...
    <section id="about" className="relative bg-transparent pt-8 pb-4 md:py-32 px-6 overflow-hidden">
      <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-16 items-center">
        ...
        <div className="relative w-full mt-4 md:mt-0">
          <img src={`${import.meta.env.BASE_URL}photo/vhod.jpg`} alt="Вход в Syndicate" className="relative z-10 w-full h-auto block border-2 border-accent grayscale-[30%] contrast-125" />
        </div>
      </div>
    </section>
  );
        ...
        <div className="w-full md:w-7/12 order-1 md:order-2">
          <div className="flex justify-between items-start mb-6 md:mb-12">
            ...
            <div className="flex flex-col items-center md:hidden mt-2">
              <img src={`${import.meta.env.BASE_URL}vector-chair.png`} alt="Chair" className="w-16 h-16 object-contain mix-blend-screen opacity-80" />
              <div className="font-display text-[8px] tracking-widest text-white/50 mt-1 uppercase">SYNDICATE</div>
            </div>
          </div>
