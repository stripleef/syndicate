...
const Hero = ({ onOpenBooking }) => {
  ...
  return (
    <header ref={heroRef} className="relative w-full h-[100svh] overflow-hidden flex flex-col bg-[#050505]">
       ...
       <div className="relative z-10 flex flex-col md:flex-row justify-between items-center px-4 md:px-12 py-2 md:py-6 gap-2 md:gap-0 bg-black/40 backdrop-blur-2xl text-[11px] md:text-sm font-oswald tracking-[0.2em] text-parchment/90 font-bold uppercase mt-auto border-t border-white/10 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
