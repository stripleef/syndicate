...
const Hero = ({ onOpenBooking }) => {
  ...
  return (
    <header ref={heroRef} className="relative w-full h-[100svh] overflow-hidden flex flex-col bg-[#050505]">
       ...
       <div className="relative z-10 flex flex-col md:flex-row justify-between items-center px-4 md:px-12 pt-4 pb-1 md:py-6 gap-2 md:gap-0 bg-black/40 backdrop-blur-2xl text-[11px] md:text-sm font-oswald tracking-[0.2em] text-parchment/90 font-bold uppercase mt-auto border-t border-white/10 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
        ...
        <div className="w-full md:w-7/12 order-1 md:order-2">
          <div className="mb-6 md:mb-12 flex justify-between items-center">
            <div>
              ...
              <h2 className="font-display text-6xl md:text-8xl text-white tracking-wider drop-shadow-lg leading-none">FAQ</h2>
            </div>
            <img src={`${import.meta.env.BASE_URL}vector-chair.png`} alt="Vintage Chair" className="w-24 md:hidden object-contain mix-blend-screen opacity-90" />
          </div>
