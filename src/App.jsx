...
const Navbar = () => {
  ...
  return (
    <nav className="absolute top-0 left-0 w-full z-50 flex flex-row items-start md:items-center justify-between px-2 md:px-8 pt-0 pb-4 md:py-6 font-oswald tracking-widest text-[10px] md:text-sm text-parchment uppercase bg-transparent">
